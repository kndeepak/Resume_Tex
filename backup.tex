...
\begin{center}
    \textbf{\Huge \scshape Deepak Kasi Nathan} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:+18126069724}{+1 812 606 9724}
    $|$
    \faAt \hspace{.5pt} \href{mailto:deepak.kasi.nathan.22@gmail.com}{deepak.kasi.nathan.22@gmail.com}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://linkedin.com/in/deepak-kn}{LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/kndeepak}{GitHub}
    $|$
    \faGlobe \hspace{.5pt} \href{}{Portfolio}
    $|$
    \faMapMarker \hspace{.5pt} \href{https://maps.app.goo.gl/RSMW6Txb6bimZeei8}{Chicago}
\end{center}
